...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Engvolve is built by Bagas (8.5 IELTS scorer) and a small team in Indonesia. We are not affiliated with British Council, IDP, or Cambridge. We are a pilot-stage indie product and we are honest about that — that's also why we keep WhatsApp as our primary support channel.",
  },
  {
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <p className="text-lg">
              Straight answers from a small Indonesian team building Engvolve in
              public.
            </p>
          </div>
