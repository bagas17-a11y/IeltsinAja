...
const footerLinks = {
  product: [
    { label: "Reading Engine", href: "#reading" },
    { label: "Listening Lab", href: "#listening" },
    { label: "Writing Suite", href: "#writing" },
      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-2">
            <a
              href="#"
              className="text-2xl font-light tracking-tight text-foreground inline-block mb-4"
            >
              IELTS<span className="text-accent font-medium">Elite</span>
            </a>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-8 border-t border-border/30">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} IELTS Elite. All rights reserved.
          </p>
