...
const COACHES = [
  {
    ...
    score: "IELTS 8.5",
    bio: "Built Mumpune to give Indonesian learners the kind of feedback he wished he'd had. Focus: Writing & Speaking strategy.",
...
export default function ConsultationHub() {
  ...
  const waMessage = useMemo(() => {
    const name = profile?.full_name?.trim() || "an Mumpune Elite member";
    return `Hi Mumpune team, this is ${name}. I'd like to book a 1-on-1 coaching session with ${selectedCoach.name}.`;
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Book a 1-on-1 session with your Mumpune coach.
            </p>
          </div>
        </div>
