...
DROP TABLE IF EXISTS public.speaking_library CASCADE;

CREATE TABLE public.speaking_library (
...
-- Hometown & Home
(1, 'Hometown', 'Where are you from? What is your hometown like?', 'easy'),
(1, 'Hometown', 'What do you like most about living in your hometown?', 'easy'),
(1, 'Hometown', 'Has your hometown changed much since you were a child?', 'medium'),

-- Accommodation
(1, 'Accommodation', 'Do you live in a house or an apartment?', 'easy'),
(1, 'Accommodation', 'What is your favourite room in your home and why?', 'easy'),
(1, 'Accommodation', 'Would you prefer to live in a city or in the countryside?', 'medium'),

-- Work & Studies
(1, 'Work & Studies', 'Are you currently working or studying?', 'easy'),
(1, 'Work & Studies', 'What do you enjoy most about your job or studies?', 'easy'),
(1, 'Work & Studies', 'What kind of work would you like to do in the future?', 'medium'),

-- Family
(1, 'Family', 'Do you have a large or small family?', 'easy'),
(1, 'Family', 'How much time do you spend with your family?', 'easy'),
(1, 'Family', 'What is your favourite thing to do together as a family?', 'medium'),

-- Hobbies & Free Time
(1, 'Hobbies', 'What do you enjoy doing in your free time?', 'easy'),
(1, 'Hobbies', 'Did you have different hobbies when you were a child?', 'easy'),
(1, 'Hobbies', 'Is there a hobby you have always wanted to try?', 'medium'),

-- Music
(1, 'Music', 'What kind of music do you enjoy listening to?', 'easy'),
(1, 'Music', 'Do you play any musical instruments?', 'easy'),
(1, 'Music', 'Do you prefer listening to music alone or with other people?', 'medium'),

-- Sports & Exercise
(1, 'Sports & Exercise', 'Do you enjoy playing or watching sports?', 'easy'),
(1, 'Sports & Exercise', 'How often do you exercise?', 'easy'),
(1, 'Sports & Exercise', 'What sports are popular in your country?', 'medium'),

-- Food & Cooking
(1, 'Food & Cooking', 'What is your favourite type of food?', 'easy'),
(1, 'Food & Cooking', 'Do you prefer eating at home or at restaurants?', 'easy'),
(1, 'Food & Cooking', 'Do you know how to cook? What can you make?', 'medium'),

-- Travel
(1, 'Travel', 'Do you enjoy travelling? Where have you been?', 'easy'),
(1, 'Travel', 'What is your favourite way to travel — by plane, train, or car?', 'medium'),
(1, 'Travel', 'Is there a place you would really like to visit someday?', 'easy'),

-- Technology
(1, 'Technology', 'How important is technology in your daily life?', 'easy'),
(1, 'Technology', 'What device do you use the most?', 'easy'),
(1, 'Technology', 'Do you think people rely too much on technology these days?', 'medium'),

-- Social Media
(1, 'Social Media', 'Do you use social media? Which platforms?', 'easy'),
(1, 'Social Media', 'How much time do you spend on social media each day?', 'easy'),
(1, 'Social Media', 'Do you think social media brings people closer together or further apart?', 'medium'),

-- Reading & Books
(1, 'Reading', 'Do you enjoy reading? What do you usually read?', 'easy'),
(1, 'Reading', 'Do you prefer reading physical books or digital ones?', 'medium'),
(1, 'Reading', 'Did you read a lot when you were a child?', 'easy'),

-- Shopping
(1, 'Shopping', 'Do you enjoy shopping? What do you like to shop for?', 'easy'),
(1, 'Shopping', 'Do you prefer shopping online or in stores? Why?', 'medium'),
(1, 'Shopping', 'Has the way you shop changed compared to when you were younger?', 'medium'),

-- Weather & Seasons
(1, 'Weather & Seasons', 'What is the weather like in your country?', 'easy'),
(1, 'Weather & Seasons', 'What is your favourite season and why?', 'easy'),
(1, 'Weather & Seasons', 'Does the weather affect your mood?', 'medium'),

-- Daily Routine
(1, 'Daily Routine', 'Can you describe your typical daily routine?', 'easy'),
(1, 'Daily Routine', 'Are you more productive in the morning or in the evening?', 'easy'),
(1, 'Daily Routine', 'Has your daily routine changed much in recent years?', 'medium'),

-- Sleep & Rest
(1, 'Sleep', 'How many hours of sleep do you usually get each night?', 'easy'),
(1, 'Sleep', 'Do you think people in your country get enough sleep?', 'medium'),

-- Friends & Social Life
(1, 'Friends', 'Do you have a large group of friends or just a few close ones?', 'easy'),
(1, 'Friends', 'How do you usually spend time with your friends?', 'easy'),
(1, 'Friends', 'Has social media changed the way you keep in touch with friends?', 'medium'),

-- Art & Culture
(1, 'Art & Culture', 'Do you enjoy visiting museums or art galleries?', 'easy'),
(1, 'Art & Culture', 'Is art important to you? Why or why not?', 'medium'),

-- Environment & Nature
(1, 'Nature & Environment', 'Do you enjoy spending time in nature?', 'easy'),
(1, 'Nature & Environment', 'What do you do to help protect the environment?', 'medium'),

-- Transport
(1, 'Transport', 'How do you usually get around your city?', 'easy'),
(1, 'Transport', 'What do you think of public transport in your country?', 'medium');
...
(2, 'A Book or Film That Impressed You',
...
(2, 'A Piece of Technology You Rely On',
...
(2, 'An Important Decision You Made',
...
(2, 'A Traditional Festival or Celebration',
...
(2, 'A Difficult Problem You Solved',
...
(2, 'A Piece of Advice That Changed You',
...
(3, 'Decision Making & Life Choices',
